...
def load_custom_memory_env(experiment: str):
    memory_length, num_bits = {
        "memory_custom/0": (3, 3),
        "memory_custom/1": (10, 3),
        "memory_custom/2": (10, 5),
        "memory_custom/3": (10, 7),
        "memory_custom/4": (10, 9),
        "memory_custom/5": (30, 3),
        "memory_custom/6": (30, 5),
        "memory_custom/7": (30, 7),
        "memory_custom/8": (30, 9),
        "memory_custom/9": (30, 17),
        "memory_custom/10": (30, 25),
        "memory_custom/11": (100, 3),
        "memory_custom/12": (100, 5),
        "memory_custom/13": (100, 7),
        "memory_custom/14": (100, 9),
        "memory_custom/15": (100, 17),
        "memory_custom/16": (100, 25),
        "memory_custom/17": (100, 29),
        "memory_custom/18": (100, 35),
        "memory_custom/19": (100, 39),
    }.get(experiment)
