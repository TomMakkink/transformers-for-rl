...
from utils.visualisation import viz_attention_mem
...
def train_agent(agent, env, total_episodes=10000, logger=None, viz=False):
    ...
    for episode in range(1, total_episodes + 1):
        ...
        for t in range(experiment_config["max_steps_per_episode"]):
            ...
            if viz == True:
                weights = agent.net.memory_network.attn_output_weights
                # correct_attend = viz_attention(
                ...
                #     total_steps,
                # )
                viz_attention_mem(weights.detach().numpy(), episode, t)
