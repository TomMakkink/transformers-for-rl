...
class RelativeMultiHeadAttention(nn.Module):
    ...
    def forward(
        ...
        # print(f"Attn_output_weights shape: {attn_prob.shape}")
        # print(f"Attn 1: {attn_prob}")
        # print(f"Attn 1 shape: {attn_prob.shape}")
        attn_output_weights = attn_prob.view(bsz, self.num_heads, qlen, klen)
        # print(f"Attn 2: {attn_output_weights}")
        # print(f"Attn 2 shape: {attn_output_weights.shape}")

        attn_output_weights = attn_output_weights.sum(dim=1) / self.num_heads
        # print(f"Attn 3: {attn_output_weights}")
        # print(f"Attn 3 shape: {attn_output_weights.shape}")
...
class RelPartialLearnableMultiHeadAttn(RelMultiHeadAttn):
    ...
    def forward(self, w, r, r_w_bias, r_r_bias, attn_mask=None, mems=None):
        ...
        attn_output_weights = attn_prob.view(bsz, self.n_head, qlen, klen)
        # print(f"Attn 2: {attn_output_weights}")
        # print(f"Attn 2 shape: {attn_output_weights.shape}")
